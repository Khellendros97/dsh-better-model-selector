...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.dms-search-input:focus{border-color:var(--dsw-alias-brand-primary,#4f6ef2);}',
      ...
      '.dms-list{overflow:auto;padding:2px;min-height:0;scrollbar-width:thin;scrollbar-color:var(--dsw-alias-brand-primary,#3b82f6) transparent;}',
      '.dms-list::-webkit-scrollbar{width:8px;height:8px;}',
      '.dms-list::-webkit-scrollbar-track{background:transparent;}',
      '.dms-list::-webkit-scrollbar-thumb{background:var(--dsw-alias-brand-primary,#3b82f6);border-radius:4px;}',
      '.dms-list::-webkit-scrollbar-thumb:hover{background:var(--dsw-alias-interactive-accent,#5b7cff);}',
      ...
      '.dms-row-active{background:color-mix(in srgb,var(--dsw-alias-brand-primary,#4f6ef2) 16%,transparent);}',
      ...
      '.dms-row-check{flex:none;color:var(--dsw-alias-brand-primary,#4f6ef2);font-size:13px;line-height:1;}',
      ...
      '.dms-effort-range::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;width:14px;height:14px;border-radius:50%;background:#ffffff;border:2px solid var(--dsw-alias-brand-primary,#4f6ef2);margin-top:-5px;cursor:pointer;}',
      '.dms-effort-range::-moz-range-track{height:4px;border-radius:2px;background:var(--dsw-alias-border-l2,rgba(127,127,127,.4));}',
      '.dms-effort-range::-moz-range-thumb{width:14px;height:14px;border-radius:50%;background:#ffffff;border:2px solid var(--dsw-alias-brand-primary,#4f6ef2);cursor:pointer;}',
